"""
Command-line interface for OpenEvolve with TreeSearch
"""
...
from openevolve.tree_search.tree_controller import TreeSearch
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="OpenEvolve with TreeSearch - Evolutionary coding agent")
...
async def main_async() -> int:
    ...
    # Initialize OpenEvolve with tree search
    try:
        ...
        checkpoint_dir = os.path.join(treesearch.output_dir, "checkpoints")
